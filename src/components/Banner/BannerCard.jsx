    ...
    <div className="relative top-6 lg:-top-14">
      ...
      <div className="bg-[#f4f4f4] shadow-[2px_2px_6px_1px_rgba(100,100,111,0.2)] p-8">
        <div className="flex flex-col justify-center items-center text-center space-y-5">
            <h3 className="text-2xl lg:text-3xl font-bold text-gray-500">
        ...
        <button className="bg-[#1d306d] text-white px-5 py-2 capitalize rounded-3xl font-bold text-xl transition ease-in-out duration-300 transform cursor-pointer hover:-translate-y-1.5">
          see the video
        </button>
        </div>
      </div>
